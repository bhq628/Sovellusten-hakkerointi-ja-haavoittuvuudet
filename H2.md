...
Se tehtiin inspect elementillä etsimällä kohtaa, joka koskee PIN-koodi palkkia.  
...
Tässä tehtävässä oli tarkoitus admin konsoliin.  
Yritin käyttää ffuf:a ja saada tunnuksia kirjautumiseen, mutta en niitä löytänyt.  

![](Images/H2FASTb.png)  
![](Images/H2FASTa.png)  
common.txt tulee Miesslerin Seclistalta:  
https://raw.githubusercontent.com/danielmiessler/SecLists/master/Discovery/Web-Content/common.txt  

## e) Fix the 020-your-eyes-only vulnerability  
---

Itseltäni loppui aika kesken, ja se syynä miksi raportissa on väliaikaisesti puutteita.  
...
Daniel Miessler SecList: https://raw.githubusercontent.com/danielmiessler/SecLists/master/Discovery/Web-Content/common.txt  
