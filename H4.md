...
Tärkeimmät muuttujat ovat param_1, se pitää huolen, että ohjelmalle on annettu vain yksi syöte. param_2 pitää sisällään arvatun salasanan.  
local_c on kokonaisluku, joka kertoo mikä kirjain on vuorossa vertailussa.  
![](Images/H4tarB7.png)  
